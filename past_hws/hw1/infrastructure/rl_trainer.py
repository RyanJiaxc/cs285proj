...
class RL_Trainer(object):
    ...
    def run_training_loop(self, n_iter, collect_policy, eval_policy,
        ...
        for itr in range(n_iter):
            ...
            if self.log_video or self.log_metrics:
                ...
                avg_mean, avg_std, train_expert = self.perform_logging(
                    itr, paths, eval_policy, train_video_paths, training_logs)
                mean.append(avg_mean)
                std.append(avg_std)
                expert.append(train_expert)

                if self.params['save_params']:
                    print('\nSaving agent params')
                    self.agent.save('{}/policy_itr_{}.pt'.format(self.params['logdir'], itr))

        return mean, std, expert
    ...
    def perform_logging(self, itr, paths, eval_policy, train_video_paths, training_logs):
        ...
        if self.log_metrics:
            ...
            return logs["Eval_AverageReturn"], logs["Eval_StdReturn"], logs["Train_AverageReturn"]
